        ...
        setSelectEvent: function(element){
            ...
            if(that.settings.enable){
                ...
                selectItem.on('click',function(event){
                    ...
                    //自增方法
                    if( typeof selChangeFun === 'function' ){
                    	var selectid = $(this).parent().parent().parent().attr("id");
                    	selChangeFun(selectid, $(this).attr('data-value'));
        			}
                    
                    if( typeof customCallbackFun === 'function' ){
                    	var selectid = $(this).parent().parent().parent().attr("id");
                    	customCallbackFun(selectid, $this, $(this).attr('data-value'));
                    }
